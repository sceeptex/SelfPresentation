...
st.set_page_config(page_title='Tobias Fechner Machine Learning', page_icon="🎓",
...
st.caption("Explore my skills in machine learning, data visualization and error analysis based on the Iris dataset.")
